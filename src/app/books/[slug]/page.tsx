...
import ChapterRecapsSection from '@/components/ChapterRecapsSection'
  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Published by {book.publisher} on {new Date(book.publishedDate).toLocaleDateString()}
            </p>
          </div>
      ...
      {book.key_ideas && book.key_ideas.length > 0 && (
        <KeyIdeasSection keyIdeas={book.key_ideas} />
      )}

      {/* Chapter Recaps Section */}
      {book.chapter_recaps && book.chapter_recaps.length > 0 && (
        <ChapterRecapsSection chapterRecaps={book.chapter_recaps} />
      )}
    </div>
  )
}